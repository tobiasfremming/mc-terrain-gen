...
public class TransVoxelTables : MonoBehaviour
{
	...
	public struct RegularCellData
	{
		...
		public byte[] VertexIndex; // Length = up to 15
	...
	{
		public byte GeometryCounts;
		public byte[] VertexIndex; // Length = up to 36
		...
		{
			GeometryCounts = geometryCounts;
			VertexIndex = vertexIndex ?? System.Array.Empty<byte>();
		}
	}
	...
	public static readonly int[] regularCellClass = new int[256]
	{
	...
	public static readonly TransitionCellData[] TransitionCellDataTable = new TransitionCellData[56]
	{
		new(0x00),
